...
This project is for **educational and demonstration purposes only**. It is not a certified medical device and should not be used for professional medical diagnosis. Always consult a qualified healthcare provider.

1. Every output is generated by a large language model and may contain errors.
2. No prescription or dosage is ever recommended—only classes and categories.
3. In a medical emergency, call your local emergency services immediately.
...
Built by [Simran Singh](https://github.com/simisingh365)
